# -*- coding: utf-8 -*-
"""global ai hub python for ml guided project 3

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1bIWpq6nmwjj-tkXYBLXBQ1lH3mVhrSRj
...
file=open("macbookair/desktop/employee_revenue.txt","r")
data=file.read()
...
#Extract the revenue
revenue=string.split[revenue_index]
print(revenue)
...
print(f"""name:{name}
      ...
      average deal size: {divide}     
""")

#Check the types
print(f"""name type: {type(name)}
      number of calls type: {type(number)}
      average deal size type: {type(divide)}
...
for employee in lines:
   ...
   for i in split_employee:
     if '$' in i:
       avrg_deal_size= i 
     avrg_deal_size=avrg_deal_size.split("$")[0]
    ...
    avrg_deal_size=int(avrg_deal_size)
    revenue=int(revenue)
    call_number=int(call_number)

    #Append the information to the lists
    names.append(name)
    numbers.append(call_number)
    revenues.append(revenue)
    avrg_deal_sizes.append(avrg_deal_size)

#Print out the information
print(f"""names:{names}
      number of calls:{numbers}
      average deal sizes: {avrg_deal_sizes}
      revenues: {revenues}     
""")
...
def clean_extract(lines):
  for employee in lines:
    ...
    return names,numbers,revenues,avrg_deal_sizes

#Assign returned values to variables
names,numbers,revenues,avrg_deal_sizes = clean_extract(lines)
...
sorted=sorted(dictionary2)[0:3]
for i in sorted:
  print(dictionary2[i])

#Find the best performing employees (descending order)
sorted=sorted(dictionary2, reverse=True)[0:3]
for i in sorted:
  print(dictionary2[i])